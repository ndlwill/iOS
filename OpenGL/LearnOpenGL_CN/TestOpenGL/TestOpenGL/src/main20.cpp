...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 对GLM的projection函数中的FoV和aspect-ratio参数进行实验
        /**
         FoV设置 aspect-ratio不变：
         30 视觉放大
         80 视觉缩小
         
         FoV不变 aspect-ratio设置:
         800/1000 宽度拉伸
         800/300 宽度缩小
         */
        projection = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        // 将观察矩阵在各个方向上进行位移，来看看场景是如何改变的。
        view       = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));// 移动的是物体（场景）不是摄像机
