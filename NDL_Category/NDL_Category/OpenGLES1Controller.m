...
@implementation OpenGLES1Controller
...
-(void)setUpVertexData
{
    ...
    /*
     ...
     顶点缓存区（VBO）: 性能更高的做法是，提前分配一块显存，将顶点数据预先传入到显存当中。这部分的显存，就被称为顶点缓冲区
     */
    ...
    参数列表:
        ...
        size, 每次读取数量。（如position是由3个（x,y,z）组成，而颜色是4个（r,g,b,a）,纹理则是2个（s,t）.）
    ...
    /**
     ...
     GLKVertexAttribTexCoord1//纹理1 GLKBaseEffect只支持2个纹理
     */
    
    //顶点坐标数据
    // (4)打开对应attribute的开关（顶点数据）
